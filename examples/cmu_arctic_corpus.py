...
The CMU ARCTIC database is open and can be downloaded automatically as
demonstrated here.

[1] J. Kominek and A. W. Black, CMU ARCTIC: databases for speech synthesis, Tech. Rep.,
    CMU, 2003.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--noplot", action="store_true", help="Do not display any plot")
    parser.add_argument(
        "--playsound", action="store_true", help="Play one example sentence"
    )
