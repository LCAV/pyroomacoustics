...
overlapping block with Hann windowing and apply a moving average filter in the
...
stft = pra.realtime.STFT(block_size, fs, hop=hop, analysis_window=window, channels=1)
