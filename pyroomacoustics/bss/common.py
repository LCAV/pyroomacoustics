...
def sparir(G, S, weights=np.array([]), gini=0):
    '''
   Fast proximal algorithm for sparse approximation of (relative) impulse response from
   incomplete measurements of the corresponding (relative) transfer function based on
    ...
    maxiter = 50    # maximum number of iterations of the fast gradient algorithm
