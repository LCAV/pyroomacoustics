...
# compute azimuth_s and colatitude_s pair for images along y-axis
...
image_1_angles = source_angle_array[:,1]
image_2_angles = source_angle_array[:,5]
...
class Test_Source_Directivity_Y(TestCase):

    def test_image_1(self):
        self.assertTrue(azimuth_s_1 == -np.pi/4)
...
def get_error_image_1():
    ...
    print("Error in image 1 along y-axis")
    error_azimuth = abs(azimuth_s_1 - (-np.pi/4))
...
def get_error_image_2():
    ...
    print("Error in image 2 along y-axis")
