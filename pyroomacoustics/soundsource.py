...
class SoundSource(object):
    ...
    def __str__(self):
        str_signal = str(self.signal) if isinstance(self.signal, Signal) else "ndarray"
        return f'Soundsource instance at {self.position} with signal {str_signal}'
    ...
    def add_signal(self, signal):
        ...
        Parameters
        ----------
        signal: ndarray or Signal instance
            can be either a N-length ndarray, representing a sequence of samples generated by the source,
            or an instance of the Signal class.
        '''
        self.signal = signal
